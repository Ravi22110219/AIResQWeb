...
const Footer = () => {
  ...
  <option value="other">Other</option>
      ...
      <div className={styles.copyRights}>
          ...
          <p>AIResQ Climsols Pvt. Ltd.<span className="far fa-copyright" style={{display:'flex', gap:'5px'}}> <FaRegCopyright className="mt-1 ml-1" /> <b style={{fontWeight:'normal'}}>2026</b></span>  All Rights Reserved<span className="far fa-copyright" style={{marginLeft:"5px"}}><GoArrowUpRight  /></span> </p>
        </div>
