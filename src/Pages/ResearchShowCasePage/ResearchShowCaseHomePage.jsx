...
import styles from "./ResearchShowCaseHomePage.module.css";
...
const ResearchShowCaseHomePage = () => {
  ...
  return (
    <>
        <div className="w-full bg-gray-800 h-40  flex items-center justify-center">
...
export default ResearchShowCaseHomePage;
