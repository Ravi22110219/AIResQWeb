...
const JobRoles = () => {
  ...
  const jobOpenings = [
    ...
    // },
    {
      ...
      description:
        "This internship is ideal for a design student or recent graduate who wants to explore real-world branding, digital storytelling, and social media design. You'll work directly with the founding team, contributing to the visual identity of a company working on AI-powered flood prediction and mitigation solutions for Indian cities.",
      about_company:
        'AIResQ ClimSols is a team of researchers from IIT Gandhinagar working on providing flood prediction, mitigation, relief and resilience solutions to Indian cities. Our mission is to ensure sustainable urban development by leveraging AI to create smart cities.',
      key_responsibilities: [
        'Creating design concepts and visual drafts for brand communications',
        'Contributing to initial branding efforts (color palettes, typography, visual themes)',
        'Designing print materials (brochures, business cards)',
        'Creating social media content (Instagram, LinkedIn) including templates',
        'Pitch deck concept design and layout',
        'Designing brand merchandise (t-shirts, stationery)',
      ],
      qualifications: [
        'Pursuing/recently completed degree in Graphic Design or related field',
        'Strong understanding of basic design principles and layout techniques',
        'Familiarity with Adobe Illustrator/Photoshop/Canva/Figma',
        'Good eye for branding and attention to detail',
        'Previous design project experience (internships, freelance, or portfolio)',
        'Bonus: Knowledge of social media trends or interest in digital storytelling',
      ],
      skills: [
        'Illustrator',
        'Photoshop',
